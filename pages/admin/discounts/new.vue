<template>
  <ValidationObserver v-slot="{ handleSubmit }" ref="validator">
    <b-form
      ...
      @submit.prevent="handleSubmit(postDiscount)"
    >
...
export default Vue.extend({
  ...
  methods: {
    ...
    postDiscount() {
      this.$axios
        .$post('/discounts', this.form)
        .then(() => {
          this.$bvToast.toast(this.$t('adminDiscounts.new.success') as string, {
            title: this.$t('toastTitle.success') as string,
            variant: 'success',
          });
        ...
        .catch(() => {
          this.$bvToast.toast(this.$t('adminDiscounts.new.error') as string, {
            title: this.$t('toastTitle.error') as string,
            variant: 'danger',
          });
        });
