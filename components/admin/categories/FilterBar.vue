  ...
  <div class="d-flex background-pink justify-content-between rounded p-3">
    <div class="d-flex">
      ...
      >
        <b-form-input
          v-model="search"
          :placeholder="$t('adminCategories.filterBar.searchByCategoryName')"
          debounce="500"
          class="border-0"
          @change="filterSearch"
        >
...
export default Vue.extend({
  ...
  data() {
    return {
      ...
      statuses: [
        { value: null, text: this.$t('adminCategories.filterBar.all') },
        { value: 'active', text: this.$t('adminCategories.filterBar.active') },
        {
          value: 'inactive',
          text: this.$t('adminCategories.filterBar.inactive'),
        },
      ] as Option[],
    };
  },
